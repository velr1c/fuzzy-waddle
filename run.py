...
def resume_project(project_dir: str):
    ...
    render_path=package/"final_video.mp4"; qc_path=package/"qc_report.json"; monetization_path=package/"monetization_report.json"
    checks=[("research",project/"sources.json", "sources.json exists"),("creative",project/"script.txt", "script.txt exists"),("voice",package/"narration.wav", "narration.wav exists"),("mixing",package/"final_mix.wav", "final_mix.wav exists"),("timeline",project/"timeline"/"timeline.json", "timeline.json exists"),("kdenlive",project/"kdenlive"/"project.kdenlive", "project.kdenlive exists"),("render",render_path, "final_video.mp4 exists"),("qc",qc_path if render_path.exists() else project/"__missing_qc__", "qc_report.json exists"),("monetization",monetization_path if render_path.exists() and qc_path.exists() else project/"__missing_monetization__", "monetization_report.json exists")]
